        ...
        <div class="mdl-cell mdl-cell--5-col" style="height:89.8%; background:white">
            ...
            <div class="mdl-cell mdl-cell--12-col" style="height:50%; background:white">
                <div class="mdl-cell mdl-cell--7-col" style="height:96.3%; float:left; background:beige">
                    <?php if($StoryInfo[0]->storyRepresentImage) { ?>
                    ...
                    <?php } else { ?>
                             <div style="height:75%; width:100%; background-image: url('<?=URL?>/images/story_represent_image/basic.jpg'); background-size: 100% 100%;"> 
                    <?php } ?>
                    </div>
                    <div style="height:25%; width:100%; background:whitesmoke">
                        ...
                        <div style="width:100%; height:50%; background:whitesmoke;">
                            ...
                            <div style="width:40%; height:100%; float:right;">
                                <a style="font-size:20px; marginr-right:30%;"><?php
                ...
                <div class="mdl-cell mdl-cell--5-col" style="height:96.3%; float:right; background:whitesmoke">
                    <div class="mdl-cell mdl-cell--12-col" style="height:33.5%; background:whitesmoke">
                        <div style="width:39%; height:32%; background:salmon; float:left; border-bottom:solid beige 1px;">
                            <a style="float:left; margin-left:8px; font-size:17px; line-height:40px; font-weight:bold;">旅行の日</a>
                        </div>
                        <div style="width:61%; height:32%; background:whitesmoke; float:right; border-bottom:solid beige 1px;">
                            <a style="float:left; margin-left:8px; font-size:19px; line-height:40px;"><?=$StoryInfo[0]->storyStartDate?></a>
                        </div>
                        <div style="width:39%; height:32%; background:salmon; float:left; border-bottom:solid beige 1px;">
                            <a style="float:left; margin-left:8px; font-size:17px; line-height:40px; font-weight:bold;">テーマ</a>
                        </div>
                        <div style="width:61%; height:32%; background:whitesmoke; float:right; border-bottom:solid beige 1px;">
                            <a style="float:left; margin-left:8px; font-size:19px; line-height:40px;">
                                <?php
                        ...
                        <a style="float:left; margin-left:8px; font-size:17px; height:32%;line-height:40px; font-weight:bold;">リーダー</a>
                        </div>
                        <div style="width:61%; height:33%; background:whitesmoke; float:right;">
                         <a style="float:left; margin-left:8px; font-size:19px; line-height:40px;"><?=$StoryInfo[0]->memberNickname?></a>
                        </div>
                    </div>
                    <div class="mdl-cell mdl-cell--12-col" style=" height:60%; background:whitesmoke">

                        <div style="width:100%; height:10%; background:salmon;"><a style="margin-right:35.5%; float:right; font-size:18px; line-height: 25px; font-weight:bold;">写真見る</a></div>
<!--                        <div id="topControl" class="control center" style="width:49.7%; height:40%; background:whitesmoke; float:left; border-right:solid 1px salmon;" >-->
                        <div style="width:49.3%; height:40%; background:whitesmoke; float:left; border-right:solid salmon 1px;" >
                            <button  type="button" class="mdl-button" style="width:100%; height:100%; "><a href="/Storydetail/storyDetail/<?php echo $storyIdx ?>/1/0"><img src="<?=URL?>/images/etc_icon/album.png" style="width:70px; height:70px; padding:10% 0% 10% 0%"></a></button>
                        </div>
                        <div style="width:49.3%; height:40%; background:whitesmoke; float:right" >
                        ...
                        <div style="width:100%; height:10%; background:salmon; float:right;"><a style="margin-right:43%; float:right; font-size:18px; line-height: 25px; font-weight:bold;">共有</a></div>
                     ...
                     'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank"
                                   alt="Share on Twitter" ><img src="<?=URL?>/images/sns_icon/twitter_icon.png" style="width:50px; height:50px; "></a>
                            </div>
                     ...
                     'menubar=no,toolbar=no,resizable=yes,scrollbars=yes,height=300,width=600');return false;" target="_blank"
                                   alt="Share on Facebook" ><img src="<?=URL?>/images/sns_icon/facebook_icon.png" style="width:50px; height:50px;"></a>
                            </div>
                                <div style="width:24%; height:100%; float:left; margin-top:7%;">
                     ...
                     scrollbars=yes,height=350,width=600');return false;" target="_blank" alt="Share on Google+">
                                    <img src="<?=URL?>/images/sns_icon/googleplus_icon.png" style="width:50px; height:50px;"></a>
                                </div>
                     ...
                     height=400,width=600');return false;" target="_blank" alt="Share on kakaostory">
                                    <img src="<?=URL?>/images/sns_icon/line_icon.png" style="width:50px; height:50px;"></a>
                                    </div>
            ...
            <div class="mdl-cell mdl-cell--6-col" style="height:46.3%; background:whitesmoke; float:left; overflow-y: auto; overflow-x: hidden;">
                <div style="width:100%; height:10%; background:#d1c4e9"><a style="font-size:23px; margin-top:3%; margin-left:41%; float:left; font-weight:bold;">同行者</a></div>
                <?php foreach($StoryCompanion as $Companion){ ?>
                    ...
                    <div style="width:100%; height:20%; background:#b2ebf2; border-bottom:solid black 1px; " >
                        ...
                        <img src="<?=URL?>/images/user_profile_image/<?=$Companion->memberProfile.'.'.$Companion->memberProfileExt?>" style="width:50px; height:50px;">
                        <a style="font-size:20px;"><?=$Companion->memberNickname?></a>
                        </button>
                    </div>
            ...
            <div class="mdl-cell mdl-cell--6-col" style="height:46.3%; background:whitesmoke; float:right; ">
                <div style="width:100%; height:10%; background:#d1c4e9";><a style="font-size:23px; margin-left:33%; margin-top:3%; padding-height:50px; float:left; font-weight:bold; ">旅行コメント</a></div>
        ...
        <div class="mdl-cell mdl-cell--7-col" style="height:89.8%;  background:white">
            ...
            <div class="mdl-cell mdl-cell--5-col" style="height:41.3%; float:left; background:dodgerblue">
                <div style="width:100%; height:65%; background:whitesmoke;">
                    <img src="<?= URL; ?>/images/place/<?= $StoryPlaceInfo[$StoryPlaceIdx]->placeIdx; ?>/<?=$StoryPlaceInfo[$StoryPlaceIdx]->PlaceImageName.'.'.$StoryPlaceInfo[$StoryPlaceIdx]->PlaceImageExt?>" style="width:100%; height:100%;">
                </div>
                <div style="width:100%; height:35%; background:whitesmoke;">
                    <div style="width:100%; height:30%; background:skyblue;">
                        <a style="font-size:20px; line-height:30px; font-weight:bold;"><?=$StoryPlaceInfo[$StoryPlaceIdx]->placeName?></a>
                        <a><?=$StoryPlaceInfo[$StoryPlaceIdx]->placeNation?></a>
                    </div>
                    <div style="width:100%; height:55%; background:whitesmoke;">
                        <a style="font-size:25px;"><?=$StoryPlaceInfo[$StoryPlaceIdx]->placeExplain?></a>
                    </div>
