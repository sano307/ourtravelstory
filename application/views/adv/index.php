...
<div style="margin-left:5%;">
    <form action="/adv/add_adv" method="post" enctype="multipart/form-data">
        ...
        <h3>* 広告のタイトル</h3>
        <input type="text" name="adv_name" placeholder="ex) Our Travel Story!!" style="min-width:40%; font-size:25px;">
        <h3>* 半径設定</h3>
        ...
        <h3>* コメント</h3>
        <textarea name="adv_comment" placeholder="広告のコメントや説明をご記入ください！" style="min-width:50%; min-height:20%; resize:none;"></textarea><p></p>
