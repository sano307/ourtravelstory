...
$member_profile_img_name = isset($_SESSION['MemberProfile']) ? $_SESSION['MemberProfile'] : null;
$member_profile_img_ext = isset($_SESSION['MemberProfileExt']) ? $_SESSION['MemberProfileExt'] : null;
        ...
        <div class="mdl-layout__header-row" style="height: 61px;">
          ...
          <div class="android-navigation-container">
            <nav class="android-navigation mdl-navigation">
              <img src="<?php echo URL; ?>/images/user_profile_image/<?= $member_profile_img_name; ?>.<?= $member_profile_img_ext; ?>" style="height: 36px; width: 36px; border-radius: 50%;">
              <p style="font-weight: bold; font-size: 24px; color: black; margin-top: 12px; margin-left: 12px;"><?php echo $member_nickname; ?></p>
            </nav>
          </div>
