...
class StoryDetail extends CI_Controller {
    ...
    public function storyDetail($storyIdx, $placeDate, $storyplaceIdx) {
        ...
        if($storyplaceIdx == 0){
            $storyplaceIdx = $this->ourtravelstory_m->StoryPlaceIdxCheck($storyIdx,$placeDate);
        ...
        $this->load->view('../views/public/header1.php');
        ...
        $this->load->view('../views/public/footer1.php');
    }
