    ...
    return e.on = function (t, e) {
        ...
        if (n && n.length) {
            ...
            for (var o = this._onceEvents && this._onceEvents[t]; s;) {
                var r = o && o[s];
                r && (this.off(t, s), delete o[s]), s.apply(this, e), i += r ? 0 : 1, s = n[i]
            }
            return this
        }
    }, t
...
!function (e, t) {
    "use strict";
    "function" == typeof define && define.amd ? define(["matches-selector/matches-selector"], function (r) {
        return t(e, r)
    ...
    r.extend = function (e, t) {
        ...
        var t = [];
        if (Array.isArray(e))t = e; else if (e && "number" == typeof e.length)for (var r = 0; r < e.length; r++)t.push(e[r]); else t.push(e);
        return t
    ...
    return r.htmlInit = function (t, o) {
        r.docReady(function () {
            var u = r.toDashed(o), a = "data-" + u, i = document.querySelectorAll("[" + a + "]"), c = document.querySelectorAll(".js-" + u), s = r.makeArray(i).concat(r.makeArray(c)), f = a + "-options", d = e.jQuery;
...
!function (t, i) {
    "function" == typeof define && define.amd ? define(["ev-emitter/ev-emitter", "get-size/get-size"], function (n, o) {
        return i(t, n, o)
    }) : "object" == typeof module && module.exports ? module.exports = i(t, require("ev-emitter"), require("get-size")) : (t.Outlayer = {}, t.Outlayer.Item = i(t, t.EvEmitter, t.getSize))
    ...
    var r = document.documentElement.style, a = "string" == typeof r.transition ? "transition" : "WebkitTransition", h = "string" == typeof r.transform ? "transform" : "WebkitTransform", l = {
        WebkitTransition: "webkitTransitionEnd",
        transition: "transitionend"
    }[a], u = [h, a, a + "Duration", a + "Property"], d = e.prototype = Object.create(i.prototype);
    d.constructor = e, d._create = function () {
        ...
        var t = getComputedStyle(this.element), i = this.layout._getOption("originLeft"), n = this.layout._getOption("originTop"), o = t[i ? "left" : "right"], e = t[n ? "top" : "bottom"], s = this.layout.size, r = -1 != o.indexOf("%") ? parseFloat(o) / 100 * s.width : parseInt(o, 10), a = -1 != e.indexOf("%") ? parseFloat(e) / 100 * s.height : parseInt(e, 10);
    ...
    }, d._transitionTo = function (t, i) {
        this.getPosition();
        var n = this.position.x, o = this.position.y, e = parseInt(t, 10), s = parseInt(i, 10), r = e === this.position.x && s === this.position.y;
    ...
    }, d.moveTo = d._transitionTo, d.setPosition = function (t, i) {
    ...
    var p = "opacity," + s(u.transform || "transform");
    d.enableTransition = function () {
        this.isTransitioning || (this.css({
            transitionProperty: p,
            transitionDuration: this.layout.options.transitionDuration
        }), this.element.addEventListener(l, this, !1))
    }, d.transition = e.prototype[a ? "_transition" : "_nonTransition"], d.onwebkitTransitionEnd = function (t) {
    ...
    d.ontransitionend = function (t) {
        if (t.target === this.element) {
            var i = this._transn, n = f[t.propertyName] || t.propertyName;
            if (delete i.ingProperties[n], o(i.ingProperties) && this.disableTransition(), n in i.clean && (this.element.style[t.propertyName] = "", delete i.clean[n]), n in i.onEnd) {
                var e = i.onEnd[n];
                e.call(this), delete i.onEnd[n]
            }
...
!function (t, i) {
    ...
    return e.compatOptions.fitWidth = "isFitWidth", e.prototype._resetLayout = function () {
        ...
        var o = this.columnWidth += this.gutter, h = this.containerWidth + this.gutter, s = h / o, n = o - h % o, r = n && 1 > n ? "round" : "floor";
        s = Math[r](s), this.cols = Math.max(s, 1)
    }, e.prototype.getContainerWidth = function () {
        var t = this._getOption("fitWidth"), e = t ? this.element.parentNode : this.element, o = i(e);
        this.containerWidth = o && o.innerWidth
    }, e.prototype._getItemLayoutPosition = function (t) {
        t.getSize();
        var i = t.size.outerWidth % this.columnWidth, e = i && 1 > i ? "round" : "ceil", o = Math[e](t.size.outerWidth / this.columnWidth);
        ...
        var e = i(t), o = this._getElementOffset(t), h = this._getOption("originLeft"), s = h ? o.left : o.right, n = s + e.outerWidth, r = Math.floor(s / this.columnWidth);
        r = Math.max(0, r);
...
(function () {
    ...
    r.getListeners = function (e) {
        ...
        for (s in u)if (u.hasOwnProperty(s))for (n = u[s].slice(0), i = n.length; i--;)r = n[i], r.once === !0 && this.removeListener(e, r.listener), o = r.listener.apply(this, t || []), o === this._getOnceReturnValue() && this.removeListener(e, r.listener);
        return this
...
!function (t, e) {
    "use strict";
    "function" == typeof define && define.amd ? define(["eventEmitter/EventEmitter"], function (i) {
        return e(t, i)
    }) : "object" == typeof module && module.exports ? module.exports = e(t, require("wolfy87-eventemitter")) : t.imagesLoaded = e(t, t.EventEmitter)
}(window, function (t, e) {
    "use strict";
    function i(t, e) {
    ...
    return r.prototype.addElementBackgroundImages = function (t) {
        ...
        this.progressedCount++, this.hasAnyBroken = this.hasAnyBroken || !t.isLoaded, this.emit("progress", this, t, e), this.jqDeferred && this.jqDeferred.notify && this.jqDeferred.notify(this, t), this.progressedCount == this.images.length && this.complete(), this.options.debug && a && a.log("progress: " + i, t, e)
...
!function (t) {
    ...
    var n = t.MD = {};
    n.pages = {}, n.modules = {}, t.filterBindEvent = function (t, e, n, i) {
    ...
    document.addEventListener("DOMContentLoaded", function () {
        i = document.querySelector("#notification");
        for (var t = document.querySelectorAll("[data-js-module]"), e = 0; e < t.length; e++) {
            var o = t[e], a = o.getAttribute("data-js-module"), r = n.modules[a];
            r && r(o)
        }
    }), n.getItemElement = function () {
    ...
    }, n.getSomeItemElements = function () {
        for (var t = document.createDocumentFragment(), e = [], n = 0; 3 > n; n++) {
            var i = document.createElement("div"), o = Math.random(), a = o > .85 ? "w4" : o > .7 ? "w2" : "", r = Math.random(), d = r > .85 ? "h4" : r > .7 ? "h2" : "";
            i.className = "item " + a + " " + d, t.appendChild(i), e.push(i)
        }
    };
    var o, a = document.documentElement, r = "string" == typeof a.style.transition ? "transition" : "WebkitTransition", d = r ? 1e3 : 1500;
    n.notify = function (t) {
        i.textContent = t + " at " + e(), i.style[r] = "none", i.style.display = "block", i.style.opacity = "1", clearTimeout(o), o = setTimeout(n.hideNotify, d)
    }, n.hideNotify = function () {
        r ? (i.style[r] = "opacity 1.0s", i.style.opacity = "0") : i.style.display = "none"
    }
}(window);
...
MD.modules["appended-demo"] = function (e) {
    "use strict";
    var t = e.querySelector(".grid"), n = new Masonry(t, {columnWidth: 80}), d = e.querySelector(".append-button");
    d.addEventListener("click", function () {
        var e = [MD.getItemElement(), MD.getItemElement(), MD.getItemElement()], d = document.createDocumentFragment();
        d.appendChild(e[0]), d.appendChild(e[1]), d.appendChild(e[2]), t.appendChild(d), n.appended(e)
    })
};
MD.modules["destroy-demo"] = function (e) {
    "use strict";
    var t = e.querySelector(".grid"), o = {columnWidth: 80}, n = new Masonry(t, o), r = !0, c = e.querySelector(".toggle-button");
    c.addEventListener("click", function () {
        r ? n.destroy() : n = new Masonry(t, o), r = !r
    })
};
MD.modules["fizzy-bear-shirt"] = function (e) {
    "use strict";
    var t = new Date(2016, 5, 9), r = Math.round((t - new Date) / 864e5);
...
MD.modules["layout-complete-demo"] = function (t) {
    "use strict";
    var e = t.querySelector(".grid"), o = new Masonry(e, {columnWidth: 80});
    o.on("layoutComplete", function (t) {
        MD.notify("Masonry layout completed on " + t.length + " items")
    }), filterBindEvent(e, "click", ".grid-item", function (t) {
        t.target.classList.toggle("grid-item--gigante"), o.layout()
    })
};
MD.modules["layout-demo"] = function (t) {
    "use strict";
    var e = t.querySelector(".grid"), i = new Masonry(e, {columnWidth: 80});
    filterBindEvent(e, "click", ".grid-item", function (t) {
...
MD.modules["refactor-shirt"] = function (t) {
    "use strict";
...
MD.modules["remove-demo"] = function (e) {
    "use strict";
    var t = e.querySelector(".grid"), r = new Masonry(t, {columnWidth: 80});
    filterBindEvent(t, "click", ".grid-item", function (e) {
        r.remove(e.target), r.layout()
    })
};
...
MD.modules["stamp-methods-demo"] = function (t) {
    "use strict";
    var e = t.querySelector(".grid"), o = new Masonry(e, {
        itemSelector: ".grid-item",
        columnWidth: 80
    }), r = e.querySelector(".stamp"), m = !1, n = t.querySelector(".stamp-button");
    n.addEventListener("click", function () {
        m ? o.unstamp(r) : o.stamp(r), o.layout(), m = !m
    })
};